...
namespace ApptManager.Repo
{
    public class UserRepo : IUserRepo
    {
        ...
        public async Task<string> Create(UserObj user)
        {
            ...
            string query = "Insert into Users(FirstName, LastName,Email,Password,MobileNumber,CreatedOn,UserType,AccountStatus) values (@FirstName, @LastName,@Email,@Password,@MobileNumber,@CreatedOn,@UserType)";
